...
#SBATCH --output=/gpfs/share/home/2401111663/syy/nnssl-openneuro/sbatch/output/ssa/nnssl-ssa-%j.out
#SBATCH --error=/gpfs/share/home/2401111663/syy/nnssl-openneuro/sbatch/error/ssa/nnssl-ssa-%j.err
...
for FOLD in {1..5}; do
  ...
  JSON_OUT=$DATA_ROOT/dataset_ssa_fold_${FOLD}_mae.json
  OUTPUT_DIR="${NNSSL_ROOT}/training_runs/ssa_fold${FOLD}_mae"
  mkdir -p ${OUTPUT_DIR}

  echo "Starting SSA fold ${FOLD} with MAE (ResEncL)"
